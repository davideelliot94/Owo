...
{{/* hostname for apigateway */}}
{{- define "openwhisk.nginx_host" -}}
{{ .Release.Name }}-nginx.{{ .Release.Namespace }}.svc.{{ .Values.k8s.domain }}
{{- end -}}
...
{{/* hostname for owo */}}
{{- define "openwhisk.owo_host" -}}
{{ .Release.Name }}-owo.{{ .Release.Namespace }}.svc.{{ .Values.k8s.domain }}
{{- end -}}
